...
if __name__=='__main__':  #主函数
    ...
    try:
        while(1):
            print('x_angle:%.3f    y_angle:%.3f     z_angle:%.3f ' %(angle[0], angle[1], angle[2]))
            print('x_acc:%.3f    y_acc:%.3f     z_acc:%.3f ' %(acc[0], acc[1], acc[2]))
            print('x_speed:%.3f    y_speed:%.3f     z_speed:%.3f ' %(speed[0], speed[1], speed[2]))
            print('=========================================================================')
            time.sleep(0.2)
    finally:
        ser.close()
